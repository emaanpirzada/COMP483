...
samples <-dir("..Outputs/Quantified")
samples
...
metadata_table <- metadata_table %>%
   mutate(path=file.path("../Outputs/Quantified", sample))
...
write.table(sig, file = "../Outputs/sleuth_report.txt", sep = "\t", quote = FALSE, row.names = FALSE, append = TRUE)